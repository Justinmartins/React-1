...
const Countries = () => {
    ...
    // Se joue quand le composant est monté
    useEffect(() => {
        axios
        ...
        <div className='countries'>
            <ul className='radio-container'>
                ...
                {radios.map((continent) => (
                    <li>
                        <input type="radio" id={continent} name="conntinentRadio" checked={continent === selectedRadio} onChange={(e) => setSelectedRadio(e.target.id)} />
